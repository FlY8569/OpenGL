from linuxRestView.objloader import *
from linuxRestView.projectionAndShannon import *
from linuxRestView.visibleAndDis import *
...
class particle:
    ...
    def calculateFitness(self, obj, ViewPoint, head):
        ...
        fit[3] = a1.dismin / 1000 * 2.5
        fit[4] = a1.surfaceVisibility * 15
        fit[5] = a1.eyeVisibility * 670
        fit[0] = a2.area / 10000 * 13
        fit[1] = a2.cir / 10000 * 0.42
        fit[2] = a2.shan / 100 * 0.7
        fit[6] = ViewPoint[2] / 100
        self.f.write(
