...
last edited: 2018.10
"""
from qtBestView.projectionAndShannon import *
from qtBestView.visibleAndDis import *


class particle:
    def __init__(self, obj, para):
        # 粒子树
        self.particle_num = 6
        # 迭代次数
        self.N = 100
    ...
    def calculateFitness(self, obj, ViewPoint, head):
        ...
        fit[0] = a2.area / 1000 * self.para[0]
        fit[1] = a2.cir / 1000 * self.para[1]
        fit[2] = a2.shan * self.para[2]
        fit[3] = a1.dismin / 1000 * self.para[3]
        fit[4] = a1.surfaceVisibility * self.para[4]
        fit[5] = a1.eyeVisibility * self.para[5]
        fit[6] = ViewPoint[2] / 1000 * self.para[6]
        self.f.write(
